...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Picasso.get().load("http://192.168.1.9:8000/44340?id=" + card.getIdRecipe()).fit().into(holder.recipeImage);
        Picasso.get().load("http://192.168.1.9:8000/44341?id=" + card.getIdUser()).fit().into(holder.avatar);
    }
